...
start = time.time()
period = 8
casclf = cv2.CascadeClassifier('C:\\Users\\Adil\\PycharmProjects\\SE\\haarcascade_frontalface_default.xml')
cap = cv2.VideoCapture(0)
recognizer = cv2.face.LBPHFaceRecognizer_create()
recognizer.read('C:\\Users\\Adil\\PycharmProjects\\SE\\Trainer\\trainer.yml')
flag = 0
id = 0
filename = 'filename'
dict = {
